...
const DescricaoCartao = React.forwardRef(({ className, ...props }, ref) => (
  <p
    ref={ref}
...
// Adiciona os componentes como propriedades estáticas ao Cartao
const CartaoComComponents = Object.assign(Cartao, {
  Header: CabecalhoCartao,
  Title: TituloCartao,
  Content: ConteudoCartao,
  Footer: RodapeCartao,
  Description: DescricaoCartao
});

export default CartaoComComponents;
