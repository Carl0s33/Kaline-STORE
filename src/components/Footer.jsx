            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <form className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                  <Input type="email" placeholder="Seu e-mail" className="bg-brand-background-kaline dark:bg-input flex-grow rounded-md text-sm" aria-label="Email para newsletter"/>
                  <Button type="submit" variant="default" className="btn-primary-kaline rounded-md text-sm">
                    Assinar
                  </Button>
                </form>
              </div>
