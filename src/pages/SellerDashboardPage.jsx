      ...
      return (
        ...
        >
          <header className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <Button className="btn-primary-kaline rounded-md" asChild>
          ...
          <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="p-6 bg-brand-card-kaline dark:bg-card rounded-lg shadow-lg flex items-center space-x-4"
              >
          ...
          <section>
            ...
            <div className="p-6 bg-brand-card-kaline dark:bg-card rounded-lg shadow-lg">
